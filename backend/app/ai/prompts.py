...
class StrategyPromptBuilder:
    ...
    def _build_user_prompt(self, profile: AIStrategyProfile, snapshot: MarketSnapshot) -> str:
        sections = [
            ...
            "",
            "Recent closes: " + self._format_series(snapshot.closes, max_items=100),
            "Recent highs: " + self._format_series(snapshot.highs, max_items=100),
            "Recent lows: " + self._format_series(snapshot.lows, max_items=100),
            "Recent volumes: " + self._format_series(snapshot.volumes, max_items=100),
            "",
            "Indicators:",
